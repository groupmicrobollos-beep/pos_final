...
<section data-page="reports" class="space-y-6 text-[13px]">
  <style>
  [data-page="reports"] .glass{ background:var(--bg-glass); backdrop-filter:var(--glass-blur); }
  [data-page="reports"] .card{ border:1px solid var(--border-main); border-radius:.6rem; }
  [data-page="reports"] .k{ font-size:.74rem; color:var(--text-secondary) }
  ...
  [data-page="reports"] select option{ color:var(--text-main); background-color:var(--bg-main); }
  ...
  <button id="export" class="btn btn-primary"><i class="fas fa-file-export" aria-hidden="true"></i> Exportar</button>
    </div>
  </div>
          ...
          return `
            <tr class="hover:bg-white/5">
              ...
              <td class="text-right whitespace-nowrap">
                ...
                <button data-act="edit" data-key="${b.key}" class="btn btn-secondary" style="height:28px;line-height:26px;padding:0 .45rem;"><i class="fas fa-edit" aria-hidden="true"></i></button>
                <button data-act="del"  data-key="${b.key}" data-num="${b.numero}" class="btn" style="height:28px;line-height:26px;padding:0 .45rem;"><i class="fas fa-trash" aria-hidden="true"></i></button>
              </td>
            </tr>
          `;
        }).join("");
