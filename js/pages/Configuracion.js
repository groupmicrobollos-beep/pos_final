          ...
          <section id="panel-tab-suc" class="config-panel space-y-6 max-w-6xl mx-auto hidden animate-fade-in">
             <div class="flex justify-between items-center mb-4">
                <div class="relative">
                   ...
                   <input type="text" id="branchSearch" onkeyup="window.mount.filterBranches()" placeholder="Buscar sucursal..." 
                          class="pr-4 py-2 rounded-lg border border-slate-200 dark:border-slate-700 surface focus:ring-2 focus:ring-blue-500 outline-none w-64 bg-slate-50 dark:bg-slate-900 shadow-inner"
          ...
          <section id="panel-tab-usr" class="config-panel space-y-6 max-w-6xl mx-auto hidden animate-fade-in">
             <div class="flex justify-between items-center mb-4">
                <div class="relative">
                   ...
                   <input type="text" id="userSearch" onkeyup="window.mount.filterUsers()" placeholder="Buscar usuarios..." 
                          class="pr-4 py-2 rounded-lg border border-slate-200 dark:border-slate-700 surface focus:ring-2 focus:ring-blue-500 outline-none w-64 bg-slate-50 dark:bg-slate-900 shadow-inner"
                          style="padding-left: 2.5rem !important;">
                </div>
