...
export function Topbar() {
  ...
  <button id="menuBtn" data-menu-btn aria-controls="mobileMenu" class="md:hidden inline-flex items-center px-3 py-2 rounded hover:bg-white/10" aria-expanded="false"><i class="fas fa-bars" aria-hidden="true"></i></button>
